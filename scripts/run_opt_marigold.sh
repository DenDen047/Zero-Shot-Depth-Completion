...
INPUT_DIR="/data/02_intermediate/40174_1725948826_797978120"
...
python run_opt_marigold.py --input_root_dir "$INPUT_DIR" --r_ssim_depth --inference_size 1024 1024

echo "=== Test-time alignment is completed. ==="